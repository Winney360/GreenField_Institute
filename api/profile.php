...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mb_strlen($regNum) > 20) {
        json_response(['ok' => false, 'error' => 'Registration number can be at most 20 characters.'], 422);
    }
    $thisYear = (int)date('Y');
    ...
    try {
        ...
        if ($e->getCode() === '23000') {
            json_response(['ok' => false, 'error' => 'That registration number is already taken.'], 409);
        }
        throw $e;
    }
